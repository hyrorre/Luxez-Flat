...
--]]
	...
	parts.destination = {
		...
		{id = "default_optionpanel_option_panel1",	loop = 300, op = {21}, timer = 21,	dst = {{time = 0, x = 0, y = -30, w = 1920, h = 1080, acc = 2, a = 0},{time = 150, y = -9, a = 128},{time = 300, y = 0, a = 255}}},
		{id = "default_optionpanel_option_panel1",	loop = 300, op = {-21}, timer = 31,	dst = {{time = 0, x = 0, y = 0, w = 1920, h = 1080, acc = 2, a = 255},{time = 300, y = -30, a = 0},{time = 300, y = -5000}}},
		...
		{id = "option1_text",	loop = 300, op = {21}, timer = 21,	dst = {{time = 0, x = 0, y = -30, w = 1920, h = 1080, acc = 2, a = 0},{time = 150, y = -9, a = 128},{time = 300, y = 0, a = 255}}},
		{id = "option1_text",	loop = 300, op = {-21}, timer = 31,	dst = {{time = 0, x = 0, y = 0, w = 1920, h = 1080, acc = 2, a = 255},{time = 300, y = -30, a = 0},{time = 300, y = -5000}}},
