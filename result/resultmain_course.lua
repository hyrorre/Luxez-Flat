...
local op = {
	...
	SHUTTER_OPEN_OFF	= get_property_op(),
	SHUTTER_OPEN_ON	= get_property_op(),
	SHUTTER_CLOSE_OFF	= get_property_op(),
	SHUTTER_CLOSE_ON	= get_property_op(),
}
...
local property = {
	...
	-- },def = "ON"},
	{name = "シャッター演出（OPEN）", item = {
		{name = "OFF",		op = op.SHUTTER_OPEN_OFF},
		{name = "ON",		op = op.SHUTTER_OPEN_ON},
	},def = "ON"},
	{name = "シャッター演出（CLOSE）", item = {
		{name = "OFF",		op = op.SHUTTER_CLOSE_OFF},
		{name = "ON",		op = op.SHUTTER_CLOSE_ON},
	},def = "ON"},
}
...
local function main()
	...
	skin.image = {
		...
		{id = "flame_right",		src = "flame",	x = 557*3, y = 0, w = 557, h = 1010},
		{id = "flame_right_ir",		src = "flame",	x = 557*2, y = 0, w = 557, h = 1010},
		{id = "result_infomation",		src = "result_infomation",	x = 0, y = 0, w = 430, h = 170},
		{id = "frame_center_clear",		src = "flame",	x = 557*4 + 794 * 2, y = 0, w = 794, h = 1080},
		{id = "frame_center_failed",		src = "flame",	x = 557*4 + 794 * 3, y = 0, w = 794, h = 1080},
		...
		{id = "big_clear_light", src = "clear_failed_light", x = 0, y = 750, w = 700, h = 250},
		{id = "big_failed_light", src = "clear_failed_light", x = 0, y = 1000, w = 700, h = 250},
		...
		{id = "big_clear_2", src = "clear_failed_2", x = 0, y = 750, w = 700, h = 250},
		{id = "big_failed_2", src = "clear_failed_2", x = 0, y = 1000, w = 700, h = 250},
	...
	skin.text = {
		...
		{id = "default_info_title_1st",		font = "font_songlist", size = 20, align = 0, ref = 150, overflow = 1},
		{id = "default_info_title_2nd",		font = "font_songlist", size = 20, align = 0, ref = 151, overflow = 1},
		{id = "default_info_title_3rd",		font = "font_songlist", size = 20, align = 0, ref = 152, overflow = 1},
		{id = "default_info_title_4th",		font = "font_songlist", size = 20, align = 0, ref = 153, overflow = 1},
		{id = "default_info_title_5th",		font = "font_songlist", size = 20, align = 0, ref = 154, overflow = 1},
	}
	...
	skin.destination = {
		...
		{id = "default_info_title",	filter = 1, dst = {{x = 960, y = 110-40 + 20, w = 800, h = 30}}},
		-- {id = "default_info_artist", filter = 1, dst = {{x = 960, y = 110-40 + 20, w = 800, h = 24}}},

		{id = "default_info_title_1st", draw = function() return result_mode == 0 end, filter = 1, loop = timer_tag[2], dst = {{time = timer_tag[1], x = frame_position.x+1490 - result_r, y = frame_position.y+618-65-48*0+10, w = 310, h = 24, a = 0},{time = timer_tag[2], y = frame_position.y+618-65-48*0, a = 255}}},
		{id = "default_info_title_2nd", draw = function() return result_mode == 0 end, filter = 1, loop = timer_tag[2], dst = {{time = timer_tag[1], x = frame_position.x+1490 - result_r, y = frame_position.y+618-65-48*1+10, w = 310, h = 24, a = 0},{time = timer_tag[2], y = frame_position.y+618-65-48*1, a = 255}}},
		{id = "default_info_title_3rd", draw = function() return result_mode == 0 end, filter = 1, loop = timer_tag[2], dst = {{time = timer_tag[1], x = frame_position.x+1490 - result_r, y = frame_position.y+618-65-48*2+10, w = 310, h = 24, a = 0},{time = timer_tag[2], y = frame_position.y+618-65-48*2, a = 255}}},
		{id = "default_info_title_4th", draw = function() return result_mode == 0 end, filter = 1, loop = timer_tag[2], dst = {{time = timer_tag[1], x = frame_position.x+1490 - result_r, y = frame_position.y+618-65-48*3+10, w = 310, h = 24, a = 0},{time = timer_tag[2], y = frame_position.y+618-65-48*3, a = 255}}},
		{id = "default_info_title_5th", draw = function() return result_mode == 0 end, filter = 1, loop = timer_tag[2], dst = {{time = timer_tag[1], x = frame_position.x+1490 - result_r, y = frame_position.y+618-65-48*4+10, w = 310, h = 24, a = 0},{time = timer_tag[2], y = frame_position.y+618-65-48*4, a = 255}}},
		...
		{id = "totalnotes", dst = {{x = 1070 + 4 - 6 - 187, y = 31-1, w = 12, h = 20, a = 255}}},
	...
	do
		...
		for i = 1, 35 do
			table.insert(ir.image,	{id = "big_clear_light" .. i, src = "clear_failed_light", x = 20*(i-1), y = 750, w = 20, h = 250})
	...
	-- バー1稼働開始時間
	bar_1_start_close = 300

	-- バー1稼働時間
	bar_1_timer = 600/2

	-- バー1稼働時間
	bar_1_timer_close = 600
	...
	-- 円稼働開始時間
	circle_start_close = 200

	-- 円稼働時間
	circle_timer_close = 700
	...
	do
		table.insert(skin.destination,  {id = "shutter_background", op = {op.SHUTTER_OPEN_ON}, loop = shutter_start + shutter_timer, dst = {{time = 0, x = shutter_move_x * -0.3 * (((5-5)/5)^2), a = 255*5/5, y = 0, w = 1920, h = 1080},
				{time = shutter_start},
		...
		table.insert(skin.destination,  {id = "shutter_left", op = {op.SHUTTER_OPEN_ON}, loop = shutter_start + shutter_timer, dst = {{time = 0, x = shutter_move_x * -1 * (((5-5)/5)^2), a = 255*5/5, y = 0, w = 1920, h = 1080},
				{time = shutter_start},		
		...
		table.insert(skin.destination,  {id = "shutter_right",	op = {op.SHUTTER_OPEN_ON}, loop = shutter_start + shutter_timer, dst = {{time = 0, x = shutter_right_x + shutter_move_x * 1 * (((5-5)/5)^2), a = 255*5/5, y = 0, w = 1920, h = 1080},
				{time = shutter_start},		
		...
		table.insert(skin.destination,  {id = "shutter_bar_left_1", op = {op.SHUTTER_OPEN_ON}, loop = shutter_start + bar_1_start + bar_1_timer, dst = {{time = 0, x = -695 * (((5-5)/5)^2), y = (1080 - 695) - 695 * (((5-5)/5)^2), w = 695, h = 695, a = 255},
		...
		table.insert(skin.destination,  {id = "shutter_bar_right_1", op = {op.SHUTTER_OPEN_ON}, loop = shutter_start + bar_1_start + bar_1_timer, dst = {{time = 0, x = bar_1_right_x + 1080 * (((5-5)/5)^2), y = 1080 * (((5-5)/5)^2), w = 1289, h = 1080, a = 255},
				{time = shutter_start + bar_1_start},			
		...
		table.insert(skin.destination,  {id = "shutter_circle_1", op = {op.SHUTTER_OPEN_ON}, loop = shutter_start + circle_start + circle_timer, dst = {{time = 0, x = circle_1_x, y = circle_1_y - circle_move_y * (((5-5)/5)^3), w = 1522, h = 1522, a = 255},
		...
		table.insert(skin.destination,  {id = "shutter_circle_2", op = {op.SHUTTER_OPEN_ON}, loop = shutter_start + circle_start + circle_timer, dst = {{time = 0, x = circle_2_x, y = circle_2_y + circle_move_y * (((5-5)/5)^3), w = 788, h = 788, a = 255},
				{time = shutter_start + circle_start},	
		...
		table.insert(skin.destination,  {id = "shutter", op = {op.SHUTTER_OPEN_OFF}, loop = 300, dst = {{time = 0, x = 0, y = 0, w = 1920, h = 1080, a = 255},{time = 300, a = 0}}})

		table.insert(skin.destination,  {id = "shutter", op = {op.SHUTTER_CLOSE_OFF}, loop = 1000, timer = 2,	dst = {{time = 0, x = 0, y = 0, w = 1920, h = 1080, a = 0},{time = 1000, a = 255}}})
		
		table.insert(skin.destination,  {id = "shutter_background", op = {op.SHUTTER_CLOSE_ON}, 	loop = shutter_timer_close, timer = 2, dst = {{time = 0, x = shutter_move_x * -0.3, y = 0, w = 1920, h = 1080, a = 0},
				{time = shutter_timer_close*1/5, x = shutter_move_x * -0.3 * (((5-1)/5)^2), a = 255*1/5},
				{time = shutter_timer_close*2/5, x = shutter_move_x * -0.3 * (((5-2)/5)^2), a = 255*2/5},
				{time = shutter_timer_close*3/5, x = shutter_move_x * -0.3 * (((5-3)/5)^2), a = 255*3/5},
				{time = shutter_timer_close*4/5, x = shutter_move_x * -0.3 * (((5-4)/5)^2), a = 255*4/5},
				{time = shutter_timer_close*5/5, x = shutter_move_x * -0.3 * (((5-5)/5)^2), a = 255*5/5},}})
		table.insert(skin.destination,  {id = "shutter_luster", op = {op.SHUTTER_CLOSE_ON},  blend = 0, loop = shutter_timer_close*7/5, timer = 2, dst = {{time = 0, x = shutter_move_x * -0.3, y = 0, w = 1920, h = 1080, a = 0},
				{time = shutter_timer_close*1/5, x = shutter_move_x * -0.3 * (((5-1)/5)^2), a = 255*5/40},
				{time = shutter_timer_close*2/5, x = shutter_move_x * -0.3 * (((5-2)/5)^2), a = 255*8/40},
				{time = shutter_timer_close*3/5, x = shutter_move_x * -0.3 * (((5-3)/5)^2), a = 255*10/40},
				{time = shutter_timer_close*4/5, x = shutter_move_x * -0.3 * (((5-4)/5)^2), a = 255*8/40},
				{time = shutter_timer_close*5/5, x = shutter_move_x * -0.3 * (((5-5)/5)^2), a = 255*5/40},
				{time = shutter_timer_close*7/5, x = shutter_move_x * -0.3 * (((5-5)/5)^2), a = 255*0/40},}})
		table.insert(skin.destination,  {id = "shutter_left", op = {op.SHUTTER_CLOSE_ON}, loop = shutter_timer_close,  timer = 2, dst = {{time = 0, x = shutter_move_x * -1, y = 0, w = 1920, h = 1080, a = 0},
				{time = shutter_timer_close*1/5, x = shutter_move_x * -1 * (((5-1)/5)^2), a = 255*1/5},
				{time = shutter_timer_close*2/5, x = shutter_move_x * -1 * (((5-2)/5)^2), a = 255*2/5},
				{time = shutter_timer_close*3/5, x = shutter_move_x * -1 * (((5-3)/5)^2), a = 255*3/5},
				{time = shutter_timer_close*4/5, x = shutter_move_x * -1 * (((5-4)/5)^2), a = 255*4/5},
				{time = shutter_timer_close*5/5, x = shutter_move_x * -1 * (((5-5)/5)^2), a = 255*5/5},}})
		table.insert(skin.destination,  {id = "shutter_right",	op = {op.SHUTTER_CLOSE_ON}, loop = shutter_timer_close,  timer = 2, dst = {{time = 0, x = shutter_right_x + shutter_move_x * 1, y = 0, w = 1920, h = 1080, a = 0},
				{time = shutter_timer_close*1/5, x = shutter_right_x + shutter_move_x * 1 * (((5-1)/5)^2), a = 255*1/5},
				{time = shutter_timer_close*2/5, x = shutter_right_x + shutter_move_x * 1 * (((5-2)/5)^2), a = 255*2/5},
				{time = shutter_timer_close*3/5, x = shutter_right_x + shutter_move_x * 1 * (((5-3)/5)^2), a = 255*3/5},
				{time = shutter_timer_close*4/5, x = shutter_right_x + shutter_move_x * 1 * (((5-4)/5)^2), a = 255*4/5},
				{time = shutter_timer_close*5/5, x = shutter_right_x + shutter_move_x * 1 * (((5-5)/5)^2), a = 255*5/5},}})
		table.insert(skin.destination,  {id = "shutter_bar_left_1", op = {op.SHUTTER_CLOSE_ON}, loop = bar_1_start_close + bar_1_timer_close,  timer = 2, dst = {{time = bar_1_start_close, x = -695, y = (1080 - 695) - 695, w = 695, h = 695, a = 255},
				{time = bar_1_start_close + bar_1_timer_close*1/5, x = -695 * (((5-1)/5)^2), y = (1080 - 695) - 695 * (((5-1)/5)^2)},
				{time = bar_1_start_close + bar_1_timer_close*2/5, x = -695 * (((5-2)/5)^2), y = (1080 - 695) - 695 * (((5-2)/5)^2)},
				{time = bar_1_start_close + bar_1_timer_close*3/5, x = -695 * (((5-3)/5)^2), y = (1080 - 695) - 695 * (((5-3)/5)^2)},
				{time = bar_1_start_close + bar_1_timer_close*4/5, x = -695 * (((5-4)/5)^2), y = (1080 - 695) - 695 * (((5-4)/5)^2)},
				{time = bar_1_start_close + bar_1_timer_close*5/5, x = -695 * (((5-5)/5)^2), y = (1080 - 695) - 695 * (((5-5)/5)^2)},}})
		table.insert(skin.destination,  {id = "shutter_bar_right_1", op = {op.SHUTTER_CLOSE_ON}, loop = bar_1_start_close + bar_1_timer_close,  timer = 2, dst = {{time = bar_1_start_close, x = bar_1_right_x + 1080, y = 1080, w = 1289, h = 1080, a = 255},
				{time = bar_1_start_close + bar_1_timer_close*1/5, x = bar_1_right_x + 1080 * (((5-1)/5)^2), y = 1080 * (((5-1)/5)^2)},
				{time = bar_1_start_close + bar_1_timer_close*2/5, x = bar_1_right_x + 1080 * (((5-2)/5)^2), y = 1080 * (((5-2)/5)^2)},
				{time = bar_1_start_close + bar_1_timer_close*3/5, x = bar_1_right_x + 1080 * (((5-3)/5)^2), y = 1080 * (((5-3)/5)^2)},
				{time = bar_1_start_close + bar_1_timer_close*4/5, x = bar_1_right_x + 1080 * (((5-4)/5)^2), y = 1080 * (((5-4)/5)^2)},
				{time = bar_1_start_close + bar_1_timer_close*5/5, x = bar_1_right_x + 1080 * (((5-5)/5)^2), y = 1080 * (((5-5)/5)^2)},}})
		table.insert(skin.destination,  {id = "shutter_circle_1", op = {op.SHUTTER_CLOSE_ON}, loop = circle_start + circle_timer_close,  timer = 2, dst = {{time = circle_start, x = circle_1_x, y = circle_1_y - circle_move_y, w = 1522, h = 1522, a = 0},
				{time = circle_start + circle_timer_close*1/5, y = circle_1_y - circle_move_y * (((5-1)/5)^3), a = 255*1/5},
				{time = circle_start + circle_timer_close*2/5, y = circle_1_y - circle_move_y * (((5-2)/5)^3), a = 255*2/5},
				{time = circle_start + circle_timer_close*3/5, y = circle_1_y - circle_move_y * (((5-3)/5)^3), a = 255*3/5},
				{time = circle_start + circle_timer_close*4/5, y = circle_1_y - circle_move_y * (((5-4)/5)^3), a = 255*4/5},
				{time = circle_start + circle_timer_close*5/5, y = circle_1_y - circle_move_y * (((5-5)/5)^3), a = 255*5/5},}})
		table.insert(skin.destination,  {id = "shutter_circle_2", op = {op.SHUTTER_CLOSE_ON}, loop = circle_start + circle_timer_close,  timer = 2, dst = {{time = circle_start, x = circle_2_x, y = circle_2_y - circle_move_y, w = 788, h = 788, a = 0},
				{time = circle_start + circle_timer_close*1/5, y = circle_2_y + circle_move_y * (((5-1)/5)^3), a = 255*1/5},
				{time = circle_start + circle_timer_close*2/5, y = circle_2_y + circle_move_y * (((5-2)/5)^3), a = 255*2/5},
				{time = circle_start + circle_timer_close*3/5, y = circle_2_y + circle_move_y * (((5-3)/5)^3), a = 255*3/5},
				{time = circle_start + circle_timer_close*4/5, y = circle_2_y + circle_move_y * (((5-4)/5)^3), a = 255*4/5},
				{time = circle_start + circle_timer_close*5/5, y = circle_2_y + circle_move_y * (((5-5)/5)^3), a = 255*5/5},}})	
	end
