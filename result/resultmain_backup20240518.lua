...
local filepath = {
	...
	{name = "シャッターフレーム", path = "png/shutter/*.png"},
...
local function main()
	...
	if skin_config.option["配置パターンのデフォルト表示"] == op.PATTERN_ON then 
	...
	skin.image = {
		...
		{id = "shutter_right_2",	src = "shutter_frame", x = 0, y = 1080 * 2, w = 1362, h = 1080 + 202},
	...
	skin.destination = {
		...
		{id = "big_fullcombo_shadow",  op = {90, -2245, -2244}, loop = 2000, dst = {{time = 0, x = 1920/2-1450/2, y = 1080/2-1150/2, w = 1450, h = 1150, r = 255, g = 255-26*2/3, b = 255-78*2/3, a = 0},{time = 150},{time = 300, a = 230},{time = 900, a = 255, r = 255, g = 255, b = 255},{time = 1700, a = 230, r = 255, g = 255-26*1/6, b = 255-78*1/6},{time = 1850, x = 1920/2-1450/2-1450*0.175, y = 1080/2-1150/2-1150*0.175, w = 1450*1.35, h = 1150*1.35, a = 115},{time = 2000, x = 1920/2-1450/2-1450*0.25, y = 1080/2-1150/2-1150*0.25, w = 1450*1.5, h = 1150*1.5, a = 0}}},
		{id = "big_fullcombo_2_full",  op = {90, -2245, -2244}, loop = 2000, dst = {{time = 0, x = 684-1166-64, y = 465-35+125, w = 700, h = 125, a = 255},{time = 100, x = 684-286-64},{time = 200, x = 684-36-64},{time = 650, x = 684-12-64},{time = 1100, x = 684-6-64},{time = 1700, x = 684-64},{time = 1800, x = 970-64},{time = 2000, x = 2850-64}}},
		{id = "big_fullcombo_2_combo",  op = {90, -2245, -2244}, loop = 2000, dst = {{time = 0, x = 1850-64, y = 465-35, w = 700, h = 125, a = 255},{time = 100, x = 970-64},{time = 200, x = 720-64},{time = 650, x = 696-64},{time = 1100, x = 690-64},{time = 1700, x = 684-64},{time = 1800, x = 684-286-64},{time = 2000, x = 684-2166-64}}},
		...
		{id = "big_failed_shadow",  op = {91}, loop = 2000, dst = {{time = 0, x = 1920/2-1450/2, y = 1080/2-1150/2, w = 1450, h = 1150, r = 255, g = 255-85*2/3, b = 255-102*2/3, a = 0},{time = 300, a = 204},{time = 600, a = 255, r = 255, g = 255, b = 255},{time = 1700, a = 220, r = 255, g = 255-85*1/6, b = 255-102*1/6},{time = 2000, a = 0}}},
	...
	if main_state.option(51) then
		...
		do
			...
			for i = 1, 10 do
				...
				table.insert(ir.destination, {id = "ir_rank" .. i, draw = function() return result_mode == 1 end, dst = {{x = ir.pos.rank_x - result_r,	y = v + ir.pos.rank_offset_y,	w = 14, h = 20}}})
	...
	do
		...
		-- {id = "shutter_left",	src = "shutter_left", x = 0, y = 0, w = 1920, h = 1080},
		-- {id = "shutter_right",	src = "shutter_right", x = 0, y = 0, w = 1920, h = 1080},
		-- {id = "shutter_right_2",	src = "shutter_right_2", x = 0, y = 0, w = 1362, h = 1080},
		-- {id = "LuxeFlat_logo",	src = "LuxeFlat_logo", x = 0, y = 0, w = 242, h = 87},
		-- {id = "shutter_background",	src = "shutter_background", x = 0, y = 0, w = 1920, h = 1080},
		...
		table.insert(skin.destination,  {id = "shutter", loop = 600, op = {op.SHUTTER_OFF}, timer = 2,	dst = {{time = 0, x = 0, y = 0, w = 1920, h = 1080, a = 0},{time = 600, a = 255}}})
